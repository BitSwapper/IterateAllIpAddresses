...
//bit shifting like this is faster that using the modulus operator and division in the Octets example
...
//and if both bits are 1, the corresponding result bit is set to 1. Otherwise, the result bit is set to 0.
